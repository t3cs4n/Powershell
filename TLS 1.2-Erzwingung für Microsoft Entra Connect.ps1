...
# TLS 1.2-Erzwingung für Microsoft Entra Connect



# PowerShell-Skript zur Überprüfung von TLS 1.2
...
# PowerShell-Skript zur Aktivierung von TLS 1.2
...
# PowerShell-Skript zum Deaktivieren von TLS 1.2 (nicht empfohlen)
