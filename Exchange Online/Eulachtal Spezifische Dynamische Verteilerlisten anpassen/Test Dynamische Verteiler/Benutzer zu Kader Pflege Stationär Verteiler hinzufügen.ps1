...
# Setzen des Benutzerdefinierten Attributs 1 auf den Wert "Kader Pflege Stationär" für mehrere Benutzer  >>> Powershell Befehl Zeile 16

# Setzen des Benutzerdefinierten Attributs 1 auf den Wert "Kader Pflege Stationär" für einen Benutzer  >>> Powershell Befehl Zeile 18


'hema','goyu','yaza','bosu','javi','sico','rami','scsa','prsu' | ForEach-Object {Set-AdUser -Identity $_ -Replace @{extensionAttribute1="Kader Pflege Stationär"}}

'heva' | ForEach-Object {Set-AdUser -Identity $_ -Replace @{extensionAttribute1="Kader Pflege Stationär"}}
