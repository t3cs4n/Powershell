...
$OU = "OU=00_Perskontos_Basic_Mobile,OU=Benutzer_Spitex,OU=Benutzer,OU=Eulachtal,DC=eulachtal,DC=zh"  # Modify this to match your actual OU
$NewDescription = "Mobile User mit Basic Lizenz"  # The new description to set
